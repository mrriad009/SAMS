...
export function PublicLayout() {
  ...
  const isLookupHome = pathname === '/lookup';
  ...
  return (
    <div className="flex min-h-screen flex-col bg-background dark:bg-dark-bg">
      <header className="border-b border-slate-200 bg-surface/80 backdrop-blur dark:border-slate-700 dark:bg-dark-surface/80">
        <div className="mx-auto flex w-full max-w-5xl flex-col gap-3 p-4 sm:flex-row sm:items-center sm:justify-between">
          ...
          {!isLookupHome && <StudentSearchBar className="sm:max-w-xl sm:flex-1" />}
